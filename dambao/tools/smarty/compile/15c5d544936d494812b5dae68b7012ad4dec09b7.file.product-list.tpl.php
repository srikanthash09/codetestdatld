<?php /* Smarty version Smarty-3.0.7, created on 2011-10-22 08:07:47
         compiled from "E:\Jobs\xampp\htdocs\dambao/themes/dambao/./product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:317774ea2176309dad9-95256552%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '15c5d544936d494812b5dae68b7012ad4dec09b7' => 
    array (
      0 => 'E:\\Jobs\\xampp\\htdocs\\dambao/themes/dambao/./product-list.tpl',
      1 => 1318908098,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '317774ea2176309dad9-95256552',
  'function' => 
  array (
  ),
...
" <?php if (isset($_smarty_tpl->getVariable('compareProducts',null,true,false)->value)&&in_array($_smarty_tpl->tpl_vars['product']->value['id_product'],$_smarty_tpl->getVariable('compareProducts')->value)){?>checked="checked"<?php }?> /> 
...
"<?php }?> /><?php if (isset($_smarty_tpl->tpl_vars['product']->value['new'])&&$_smarty_tpl->tpl_vars['product']->value['new']==1){?><span class="new"><?php echo smartyTranslate(array('s'=>'New'),$_smarty_tpl);?>
</span><?php }?></a>
...
" title="<?php echo smarty_modifier_escape(strip_tags(smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['description_short'],100,'...')),'htmlall','UTF-8');?>
"><?php echo strip_tags(smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['description_short'],220,'...'));?>
</a></p>
			</div>																				 

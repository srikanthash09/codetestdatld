<?php /* Smarty version Smarty-3.0.7, created on 2011-10-27 05:49:56
         compiled from "E:\Jobs\xampp\htdocs\dambao/themes/dambao/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:261254ea88e94bfd086-67348517%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '971a961f616993a60b192fc72a6d4ab2642e1d58' => 
    array (
      0 => 'E:\\Jobs\\xampp\\htdocs\\dambao/themes/dambao/product.tpl',
      1 => 1318908098,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '261254ea88e94bfd086-67348517',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_math')) include 'E:\Jobs\xampp\htdocs\dambao\tools\smarty\plugins\function.math.php';
if (!is_callable('smarty_function_counter')) include 'E:\Jobs\xampp\htdocs\dambao\tools\smarty\plugins\function.counter.php';
?>
...
" />
		...
		<!-- thumbnails -->
		<div id="views_block" <?php if (isset($_smarty_tpl->getVariable('images',null,true,false)->value)&&count($_smarty_tpl->getVariable('images')->value)<2){?>class="hidden clearfix"<?php }else{ ?>class="clearfix"<?php }?>>
...
" href="javascript:{}"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
		...
		<?php }?>
		<?php if (isset($_smarty_tpl->getVariable('images',null,true,false)->value)&&count($_smarty_tpl->getVariable('images')->value)>1){?><p class="resetimg clear"><span id="wrapResetImages" style="display: none;"><img src="<?php echo $_smarty_tpl->getVariable('img_dir')->value;?>
icon/cancel_11x13.gif" alt="<?php echo smartyTranslate(array('s'=>'Cancel'),$_smarty_tpl);?>
" width="11" height="13"/> <a id="resetImages" href="<?php echo $_smarty_tpl->getVariable('link')->value->getProductLink($_smarty_tpl->getVariable('product')->value);?>
...
" class="on_sale_img"/>
				...
				<?php if ($_smarty_tpl->getVariable('product')->value->specificPrice&&$_smarty_tpl->getVariable('product')->value->specificPrice['reduction_type']=='percentage'){?>
					<p id="reduction_percent"><span id="reduction_percent_display">-<?php echo $_smarty_tpl->getVariable('product')->value->specificPrice['reduction']*100;?>
%</span></p>
				<?php }?>
...
_small" alt="" />
									<a href="" title="<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
" >
										<img src="<?php echo $_smarty_tpl->getVariable('img_dir')->value;?>

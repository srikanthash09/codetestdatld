...
class sendToAFriend2 extends Module
{
	function __construct($dontTranslate = false)
	{
		$this->name = 'sendtoafriend2';
		$this->version = '1.1';
		...
		if(!$dontTranslate)
		{
			$this->displayName = $this->l('[Prestashop New Theme] ').$this->l('Send to a Friend module');
	...
	{
		Tools::addCSS(($this->_path).'sendtoafriend.css', 'all');
	}

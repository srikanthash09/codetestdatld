<?php /* Smarty version Smarty-3.0.7, created on 2011-10-21 18:02:36
         compiled from "E:\Jobs\xampp\htdocs\dambao/themes/dambao/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:318804ea1514c609fc3-31683225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdf48c775250251b34f95a55d2384308fc304b0a' => 
    array (
      0 => 'E:\\Jobs\\xampp\\htdocs\\dambao/themes/dambao/shopping-cart.tpl',
      1 => 1318908098,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '318804ea1514c609fc3-31683225',
  'function' => 
  array (
  ),
...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" cellpadding="0" cellspacing="0" border="0" class="std">
		<thead>
			<tr>
...
<?php }?><?php echo smartyTranslate(array('s'=>':'),$_smarty_tpl);?>
		...
		<?php if ($_smarty_tpl->getVariable('use_taxes')->value){?>
			...
			<tr class="cart_free_shipping" <?php if ($_smarty_tpl->getVariable('free_ship')->value<=0||$_smarty_tpl->getVariable('isVirtualCart')->value){?> style="display: none;" <?php }?>>
				<td colspan="5" style="white-space: normal;"><?php echo smartyTranslate(array('s'=>'Remaining amount to be added to your cart in order to obtain free shipping:'),$_smarty_tpl);?>
</td>
...
');return false;" class="voucher_name"><?php echo $_smarty_tpl->tpl_vars['voucher']->value['name'];?>
 ...
 <br />
				...
				<td colspan="2" class="price" id="total_price">
					...
					<span><?php echo Tools::displayPriceSmarty(array('price'=>$_smarty_tpl->getVariable('total_price')->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
		<?php }else{ ?>
...
');return false;" class="voucher_name"><?php echo $_smarty_tpl->tpl_vars['voucher']->value['name'];?>
 ...
 <br />
				...
				<td colspan="2" id="total_price" class="price">
					...
					<span><?php echo Tools::displayPriceSmarty(array('price'=>$_smarty_tpl->getVariable('total_price_without_tax')->value),$_smarty_tpl);?>
</span>
				</td>
			</tr>
		<?php }?>
...
">
				...
				<td class="cart_discount_description"><?php echo $_smarty_tpl->tpl_vars['discount']->value['description'];?>
</td>
